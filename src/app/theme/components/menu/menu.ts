...
export const horizontalMenuItems = [
    ...
    new Menu (20, 'NAV.PROPERTIES', null, null, null,true, 0),
      ...
      new Menu (22, 'Subasta', '/auction', null, null, false, 20),
      new Menu (23, 'Venta directa', '/direct-sale', null, null, false, 20),
      new Menu (24, 'Cesión de remate', '/auction-assignment', null, null, false, 20),
      new Menu (40, 'NAV.SERVICES', null, null, null, true, 0),
      new Menu (41, 'Saneamiento jurídico', '/service1', null, null, false, 40),
      new Menu (41, 'Aseguramiento y adecuación', '/service2', null, null, false, 40),
      new Menu (41, 'Servicio Integral', '/service3', null, null, false, 40),
